...
<head>
        ...
        <title>Account Settings | Toption</title>
        ...
        <div class="o-page__sidebar js-page-sidebar">
            <div class="c-sidebar">
                ...
                <ul class="c-sidebar__list">
                    ...
                    <li class="c-sidebar__item">
                        <a class="c-sidebar__link is-active" target="_blank" href="account-settings.php">
                    ...
                    <div class="col-12">
                        <div class="c-tabs">
                            ...
                            <ul class="c-tabs__list c-tabs__list--splitted nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="c-tabs__item"><a class="c-tabs__link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Settings</a></li>
                            </ul>
